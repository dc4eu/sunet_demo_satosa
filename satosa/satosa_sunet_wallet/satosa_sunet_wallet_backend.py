...
# Taken from IdpyOIDCBackend
class WalletBackend(BackendModule):
    """
    ...
    def start_auth(self, context, internal_request):
        ...
        print("vvv in backend")
        print(dir(internal_request))
        print(internal_request)
        print("attrs")
        print(internal_request["attributes"])
        issuer_data = requests.post("http://issuer:8080/satosa/credential", json=internal_request["attributes"])

        # fixme
        # return Response("http://issuer:8080/satosa/credential")
        return Response(message=issuer_data.text, content="application/json")
